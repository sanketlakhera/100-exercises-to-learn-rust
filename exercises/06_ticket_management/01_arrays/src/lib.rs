...
pub struct WeekTemperatures {
    temperatures: [Option<i32>; 7], // Use an array to store the temperatures for each day of the week
}
...
impl WeekTemperatures {
    ...
    pub fn get_temperature(&self, day: Weekday) -> Option<i32> {
        let index = get_weekday_index(day);
...
fn get_weekday_index(day: Weekday) -> usize {
    match day {
        Weekday::Monday => 0,
        Weekday::Tuesday => 1,
        Weekday::Wednesday => 2,
